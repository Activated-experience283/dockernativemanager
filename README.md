...
AppImage/DEB/RPM are generated by the Tauri bundle step, and the Arch package is generated in a dedicated workflow step before upload.
The `.tar.gz` artifact is also generated in a dedicated workflow step and uploaded in the same release job.
